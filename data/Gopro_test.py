...
class AdobeDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        for video in video_list:
            ...
            # frames = ['{:05d}'.format(frame) + '.jpg' for frame in frames]
    ...
    def __getitem__(self, index):
        ...
        folder_name = os.path.basename(os.path.dirname(img_LQop_l[0]))
        ...
        return {'LQs': img_LQs, 'GT': img_GTs, 'key': key, 'time': times, 'folder': folder_name}
